...
##################### TEST VALUES #####################
#path_to_save_csv_file = '/Users/mtcd/Downloads/mead_20221220'
#path_frame_files = '/Users/mtcd/Downloads/mead_20221220'
#name_to_save_csv = 'mead_csv_frames_20221220'

#path_to_save_csv_file = '/Users/mtcd/Downloads/mead_dataset_10_perc'
#path_frame_files = '/Users/mtcd/Downloads/mead_frames_10_perc'
#name_to_save_csv = 'mead_csv_frames_60_perc'

path_to_save_csv_file = '/Users/mtcd/Downloads/MEAD_DATASET/mead_70'
path_frame_files = '/Users/mtcd/Downloads/mead_frames_70_perc'
name_to_save_csv = 'mead_csv_frames_70_48x48'
dimension_1 = 48
dimension_2 = 48
...
with open(file_csv, 'w') as f:
    ...
    for file_name in dirs:
        ...
        #print(f'{file_name}: ({qty_files_init}/{qty_files})')
    ...
    #images = (np.vstack(images).reshape((-1,48,48,1)).astype('float32'))
